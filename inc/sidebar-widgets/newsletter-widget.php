...
class Br_newsletter_widget extends WP_Widget {
    ...
    function __construct() {
        ...
        esc_html__( '[ Br ] Newsletter Form', 'br-companion' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer newsletter signup form.', 'br-companion' ), )
        );
    ...
    if( $desc ){
        ...
        <div class="form-wrap" id="mc_embed_signup">
            <form target="_blank" action="<?php echo esc_url( $actionurl ); ?>" method="post" class="br_mailchimp_newsletter_widget">

                <div class="subscribe_form input-group align-items-center">
                    <input class="form-control" name="EMAIL" placeholder="<?php esc_html_e( 'Your Email Address', 'br-companion' ); ?>" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Your Email Address '" required="" type="email">
    ...
    public function form( $instance ) {
        ...
        if ( isset( $instance[ 'title' ] ) ) {
            ...
            $title = esc_html__( 'Newsletter', 'br-companion' );
        }
        ...
        if ( isset( $instance[ 'desc' ] ) ) {
            ...
            $desc = esc_html__( 'Subscribe newsletter to get all updates about discount and offers.', 'br-companion' );;
        }
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'actionurl' ) ); ?>"><?php esc_html_e( 'Action URL:' ,'br-companion'); ?></label>
            <p class="description"><?php esc_html_e( 'Enter here your MailChimp action URL.' ,'br-companion'); ?> </p>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'desc' ) ); ?>"><?php esc_html_e( 'Short Description:' ,'br-companion'); ?></label>
...
} // Class br_newsletter_widget ends here


// Register and load the widget
function br_newsletter_load_widget() {
	register_widget( 'Br_newsletter_widget' );
}
add_action( 'widgets_init', 'br_newsletter_load_widget' );