(function ($) {
    ...
    if ($.fn.owlCarousel) {
        $(".br-workflow-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.imagesLoaded) {
        $('.br-portfolio').imagesLoaded(function () {
    ...
    // MC Scripts
    var $subscribe = $('.br-subscribe-newsletter-area');
    if ($subscribe.length) {
